...
def check(username,password,rollno,email) :
    ...
    rollno=rollno+'\n'
    file_name=open("C://Users/sande/Desktop/Pariksha/main/authentication/stdb.txt","r")
    i=0
    linenumber=0
...
def face(request):
  ...
  if request.method=='POST':
    ...
    while True:
        ...
        haar_cascade = cv.CascadeClassifier("C://Users/sande/Desktop/Pariksha/main/haar_face.xml")
